...
namespace Warbase
{
	public enum BuildableState
	{
		...
		Upgrading,	// Partial building progress, but is still functional
		Destroyed,  // Buildable has no health and is a husk; non-functional
	}
	...
	public partial class BuildableEntity : ItemEntity<BuildableItem>
	{
		...
		private void Tick()
		{
			if ( Item != null )
			{
				...
				{
					DebugOverlay.Sphere( Transform.PointToWorld( snapPoint.Position ), 4f, Color.Green, 0,false );
				}
			}
		}
		...
		public override void TakeDamage( DamageInfo info )
		{
			...
			if ( info.Attacker is Player && CheckOwner( info.Attacker as Player ) && BuildableState != BuildableState.Blueprint ) return;
